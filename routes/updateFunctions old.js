      ...
      weather.getWeatherData(currentLake, function (error, data) {
        ...
        if (updateData.length > 0) {
          ...
          lakeWeather.ccWxData.push({
            time: lakeWeather.wxTime.substr(0,lakeWeather.wxTime.indexOf("M")-8) + lakeWeather.wxTime.substr(lakeWeather.wxTime.indexOf("M")-1,2),
          ...
          // use lakeWeather to update the current conditions to the database
          if (lakeUpdateFlag) {
